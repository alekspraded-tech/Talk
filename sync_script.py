    ...
    for record in records:
        ...
        if unique_db_id in existing_summaries and existing_summaries[unique_db_id]:
            ...
            prompt = (
                ...
                "**ВАЖНО. Это расшифровка видеосозвона, необходимо учитывать это и считывать контекст. Например демонстрация фин модели может происходить на экране и проговариваться голосом:**\n"
                "**Правила оценки:**\n"
